...
/// <summary>
/// Polls the FleaTrackr GitHub releases page for a newer version and exposes a flag the main
...
{
    private const string GitHubRepoUrl = "https://github.com/matthewjenner/FleaTrackr";
